...
//1d6861d77de0dff5c98e5fc34e7482ac
//218b9d141782a4dc
...
class ViewController: UIViewController {
                ...
                if error == nil{
                    if let data = data {
                        ...
                        do {
                            ...
                            print("Could not prse the data as Json")
                            return
                        }
                        
                        if let photoDictionary = parsedResult[Constants.FlickrResponseKeys.Photos] as? [String: AnyObject], photoArray = photoDictionary["photo"] as? [[String: AnyObject]]{
    ...
    override func viewDidLoad() {
        ...
        print(self.escapeParameters(someParameters))
    }
