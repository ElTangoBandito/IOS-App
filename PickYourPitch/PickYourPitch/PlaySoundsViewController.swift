...
class PlaySoundsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if (NSUserDefaults.standardUserDefaults().boolForKey("HasLaunched")){
            print("Previous launch detected")
        }
        else {
        ...
        sliderView.value = NSUserDefaults.standardUserDefaults().floatForKey("SliderValue")
    ...
    @IBAction func playAudio(sender: UIButton) {
        ...
        NSUserDefaults.standardUserDefaults().setFloat(sliderView.value, forKey: "SliderValue")
